...
namespace EC_TH2012_J.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Thongtinnhom()
        {
            if (Ds_Group == null)
            {
                ...
                Ds_Group.Add(new Thanhviennhom
                {
                    ...
                    LinkFacebook = "https://www.facebook.com/hoangphuongtshh"
                });
                Ds_Group.Add(new Thanhviennhom
                {
                    MSSV = "19810310256",
                    Hoten = "Đinh Thị Thảo",
                    LinkFacebook = "https://www.facebook.com/profile.php?id=100004365825446"
                });
                ;
            }
        ...
        public ActionResult SPNoiBat(int? skip)
        {
            ...
            splist = splist.OrderBy(r => r.MaSP).Skip(skipnum).Take(10);
            if (splist.Any())
